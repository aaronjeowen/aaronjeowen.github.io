var playState = {
  create: function() {
    ...
    timer.start();
    if (game.device.android || game.device.iOS || game.device.mobileSafari) { // add virtual controls if player is on mobile device, plug for this was created by Shawn Hymel -https://github.com/ShawnHymel/phaser-plugin-virtual-gamepad/tree/master/js
